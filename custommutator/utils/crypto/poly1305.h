...
#ifndef CUSTOMMUTATOR_CRYPTO_POLY1305_H
#define CUSTOMMUTATOR_CRYPTO_POLY1305_H
...
void poly1305_init(poly1305_context *st,
                   const unsigned char key[32]) noexcept;
void poly1305_update(poly1305_context *st, const unsigned char *m,
                     size_t bytes) noexcept;
void poly1305_finish(poly1305_context *st, unsigned char mac[16]) noexcept;

} // namespace poly1305_donna

// inline unsigned char *UCharCast(std::byte *data) {
//   return reinterpret_cast<unsigned char *>(data);
// }

// inline const unsigned char *UCharCast(const std::byte *data) {
...
#endif // CUSTOMMUTATOR_CRYPTO_POLY1305_H
