    ...
    try {
        ...
        if (isSuccess) {
            ...
            if (invoiceObj != nullptr) {
                ...
                jmethodID toHexPubMethod = currEnv->GetMethodID(pubKeyClass, "toString", "()Ljava/lang/String;");
                jstring nodeIdStr = (jstring)currEnv->CallObjectMethod(nodeIdObj, toHexPubMethod);
