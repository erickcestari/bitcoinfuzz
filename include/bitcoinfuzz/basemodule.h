...
namespace bitcoinfuzz
{
    ...
    public:
        ...
        virtual std::optional<std::string> decode_legacy_onion(std::span<const uint8_t> buffer) const;
        virtual std::optional<std::string> decode_onion(std::span<const uint8_t> buffer) const;
